...
public abstract class OnekeyShareThemeImpl implements PlatformActionListener, Callback {
    ...
    final void shareSilently(Platform platform) {
        if (formateShareData(platform)) {
            ...
            if (sp != null) {
                toast(context.getString(com.myworld.onemall.R.string.ready_to_share));
    ...
    public final boolean handleMessage(Message msg) {
        switch (msg.arg1) {
            case 1: {
                ...
                if (resId > 0) {
                    toast(context.getString(com.myworld.onemall.R.string.share_complete));
                }
            }
            break;
            case 2: {
                ...
                if ("WechatClientNotExistException".equals(expName)
                    ...
                    toast(context.getString(com.myworld.onemall.R.string.share_erroe));
            ...
            case 3: {
                // 取消
                toast(context.getString(com.myworld.onemall.R.string.share_cancel));
            }
            break;
        }
        return false;
