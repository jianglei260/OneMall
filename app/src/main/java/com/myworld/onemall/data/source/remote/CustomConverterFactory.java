...
public class CustomConverterFactory extends Converter.Factory {
    private Gson gson;
    private CodeStatusHandler handler;

    public CustomConverterFactory(CodeStatusHandler handler, Gson gson) {
        this.gson = gson;
    ...
    public Converter<ResponseBody, ?> responseBodyConverter(Type type, Annotation[] annotations,
        ...
        if (type == Boolean.class)
            return new BooleanConverter(handler);
    ...
    static final class BooleanConverter implements Converter<ResponseBody, Boolean> {
        ...
        BooleanConverter(CodeStatusHandler handler) {
            this.handler = handler;
        }
        ...
        public Boolean convert(ResponseBody value) throws IOException {
            try {
                ...
                if (code == 200)
                    ...
                    handler.handleCode(code, message);
                }
